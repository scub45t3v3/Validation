...
describe('#isPhoneNumber', () => {
  ...
  it('should return true for valid phone numbers with international calling code', () => {
    unit
  ...
  it('should return true for valid phone numbers with ios3166-1 alpha-2 code', () => {
    unit
  ...
  it('should return true for valid phone numbers with ios3166-1 alpha-3 code', () => {
    unit
  ...
  it('should return true for valid phone numbers with ios3166-1 numeric code', () => {
    unit
  ...
  it('should return true for valid phone numbers with @scuba-squad/country', () => {
    const test = {
  ...
  it('should return false for valid phone numbers with international calling code with invalid country code', () => {
    unit
  ...
  it('should return false for valid phone numbers with invalid country code', () => {
    unit
