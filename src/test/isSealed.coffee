...
describe '#isSealed', ->
  ...
  it 'should return true for frozen objects', ->
    unit
      .bool isSealed(Object.freeze({a: 5}))
      .isTrue()
  ...
  it 'should return false for non empty objects with preventExtensions', ->
    unit
      .bool isSealed(Object.preventExtensions({a: 5}))
      .isFalse()
      .bool isSealed(Object.preventExtensions({a: 'hi', b: true}))
      .isFalse()
