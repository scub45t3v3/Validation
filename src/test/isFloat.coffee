...
describe '#isFloat', ->
  ...
  it 'should return false for floats that are less than the min option', ->
    unit
      .bool isFloat(45.5, {min: 50})
      .isFalse()
      .bool isFloat(99.9, {min: 100})
      .isFalse()
      .bool isFloat('5.5', {min: '5.501'})
      .isFalse()
      .bool isFloat(5.5, {min: 5.501})
      .isFalse()
  ...
  it 'should return false for floats that are greater than the max option', ->
    unit
      .bool isFloat(45.5, {max: 45})
      .isFalse()
      .bool isFloat(100.000001, {max: 100})
      .isFalse()
      .bool isFloat('5.5', {max: '5.4999'})
      .isFalse()
      .bool isFloat(5.5, {max: 5.4999})
      .isFalse()
  ...
  it 'should return false for floats that are not mod % the step option', ->
    unit
      .bool isFloat(45.6, {step: 0.5})
      .isFalse()
      .bool isFloat(12.1, {step: 0.2})
      .isFalse()
      .bool isFloat('5', {step: '.6'})
      .isFalse()
      .bool isFloat(5, {step: .6})
      .isFalse()
  ...
  it 'should return false for floats that are not safe to cast when the safe option is true', ->
    unit
      .bool isFloat("#{Number.MAX_VALUE}9", {safe: true})
      .isFalse()
      .bool isFloat("#{Number.MIN_VALUE}9", {safe: true})
      .isFalse()
